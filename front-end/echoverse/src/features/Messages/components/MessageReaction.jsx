function MessageReaction({ reaction }) {
    ...
    return (
        <div
            className={`flex cursor-pointer items-center gap-1.5 rounded-md bg-gray-dark/90 px-1.5 py-1 font-medium  hover:text-white ${
                isReacted
                    ? "bg-blue-light/15 text-white outline outline-1 outline-blue-light"
                    : "text-white/75 outline-gray-light/40 hover:outline hover:outline-1"
            }`}
        >
