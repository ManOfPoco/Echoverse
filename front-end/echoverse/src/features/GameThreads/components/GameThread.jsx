...
function GameThread({ gameThread, game, view }) {
    ...
    return (
        <div className="rounded-lgx relative flex w-full cursor-pointer flex-col bg-gray-charcoal transition ease-in-out hover:z-30 hover:-translate-y-0.5 hover:shadow-md hover:shadow-gray-light hover:outline hover:outline-1 hover:outline-gray-light/60 hover:duration-300">
            <Link
